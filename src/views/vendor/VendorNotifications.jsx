...
function VendorNotifications() {
    ...
    const fetchUnseenData = async () => {
        try {
            const response = await axios.get(`vendor/notification-unseen/${userData?.vendor_id}/`);
    ...
    const fetchSeenData = async () => {
        try {
            const response = await axios.get(`vendor/notification-seen/${userData?.vendor_id}/`);
    ...
    const fetchStatsData = async () => {
        try {
            const response = await axios.get(`vendor/notification-summary/${userData?.vendor_id}/`);
            setNotificationStats(response.data[0]);
            console.log("Response Data Stats SUmmary", response.data[0]);
        } catch (error) {
    ...
    const handleNotificationSeenStatus = async (notiId) => {
        try {
            const response = await axios.get(
                `vendor/notification-marked-seen/${userData?.vendor_id}/${notiId}/`
            );
                                ...
                                <div className="card card-inverse card-success">
                                    <div className="card-block bg-danger p-3">
                                        ...
                                        <h1 className="display-1">
                                            {notificationStats.unread_notification}
                                        </h1>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-4 col-lg-6 mb-2">
                                <div className="card card-inverse card-success">
                                    <div className="card-block bg-success p-3">
                                        ...
                                        <h1 className="display-1">
                                            {notificationStats.read_notification}
                                        </h1>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-4 col-lg-6 mb-2">
                                <div className="card card-inverse card-success">
                                    <div className="card-block bg-primary p-3">
                                        ...
                                        <h1 className="display-1">
                                            {notificationStats.all_notification}
                                        </h1>
                                    </div>
                                </div>
                            </div>
