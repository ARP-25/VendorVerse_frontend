...
function Shop() {
    ...
    // Fetching Vendor/Shop Details
    useEffect(() => {
        apiInstance.get(`/shop/${params.slug}`).then((res) => {
            setVendor(res.data);
        });
    }, []);

    // Fetching Vendor/Shop Products
    useEffect(() => {
        apiInstance.get(`/vendor/shop-products/${params.slug}`).then((res) => {
